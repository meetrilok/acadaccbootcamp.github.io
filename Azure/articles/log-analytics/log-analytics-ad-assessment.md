...
1. Install the [Microsoft Monitoring Agent (MMA)](log-analytics-windows-agents.md) if the domain controller is not already monitored by System Center 2016 - Operations Manager or Operations Manager 2012 R2.
